                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item"> <a class="nav-link" href="{{url('/')}}">Finished events</a></li>
                            <li class="nav-item"> <a class="nav-link" href="{{url('/')}}">Upcoming Events</a></li>
                            <li class="nav-item"> <a class="nav-link" href="{{url('/')}}">Upcoming Events Within 7 days</a></li>
                            <li class="nav-item"> <a class="nav-link" href="{{url('/')}}">Finished Events Within 7 days</a></li>
                        </ul>
                    </div>
                </li>
